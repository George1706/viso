...
class Usuario(db.Model):
    ...
    codigoUsuario = db.Column(db.Integer, primary_key = True )
...
class Venta(db.Model):
    __tablename__="venta"
    codigoVenta = db.Column(db.Integer, primary_key = True )
...
class Administrador(db.Model):
    ...
    codigoAdministrador = db.Column(db.Integer, primary_key = True )
